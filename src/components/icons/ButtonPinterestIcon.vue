<template>
  <a
    :href="buildPinterestShareUrl(props.url, props.mediaUrl, props.description)"
    class="btn-link-icon btn-link-pinterest-icon"
...
import { buildPinterestShareUrl } from "../shared/share";
